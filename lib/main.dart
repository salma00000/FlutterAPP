...
void main() async {
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(create: (context) => SendForm()),
...
class MyHomePage extends StatefulWidget {
  ...
  // case the title) provided by the parent (in this case the App wichromiumdget) and
